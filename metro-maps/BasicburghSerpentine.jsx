...
const DetailPanel = ({ station, line, onClose }) => {
  ...
  return (
    <div style={{
      ...
      backgroundColor: '#0D0D0D', borderRadius: 8, overflow: 'hidden',
      ...
      <div style={{ padding: 16 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 16 }}>
          <div style={{ backgroundColor: '#1A1A1A', borderRadius: 8, padding: 12 }}>
            <p style={{ fontSize: 10, textTransform: 'uppercase', color: lineConfig.color, margin: 0 }}>Δt Required</p>
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8, marginBottom: 16 }}>
        ...
        <div style={{ backgroundColor: '#1A1A1A', borderRadius: 4, padding: 8 }}>
          <p style={{ fontSize: 10, color: '#4A4A4A', margin: 0 }}>Δt INVESTED</p>
  ...
  <div style={{
    ...
    <div style={{ display: 'flex', alignItems: 'center', gap: 12, opacity: 0.5 }}>
      ...
      <div>
        ...
        <p style={{ fontSize: 10, color: '#4A4A4A', margin: '2px 0 0 0' }}>Intermediate • 🔒 Locked</p>
      </div>
    </div>
  </div>
);
...
// Main component
export default function BasicburghSerpentine() {
  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: '100vh', backgroundColor: THEME.background, overflow: 'hidden' }}>
