...
const metroMapIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
  <!-- Metro lines -->
  <path stroke-linecap="round" stroke-linejoin="round" d="M4 8h6l4 4h6" />
  <path stroke-linecap="round" stroke-linejoin="round" d="M4 16h6l4-4" />
  <!-- Station nodes -->
...
const skillTreeIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
  <!-- Tree trunk -->
  <path stroke-linecap="round" stroke-linejoin="round" d="M12 20v-8" />
  <!-- Branches -->
  <path stroke-linecap="round" stroke-linejoin="round" d="M12 12L7 8" />
  <path stroke-linecap="round" stroke-linejoin="round" d="M12 12L17 8" />
  <path stroke-linecap="round" stroke-linejoin="round" d="M7 8L5 5" />
  <path stroke-linecap="round" stroke-linejoin="round" d="M7 8L9 5" />
  <path stroke-linecap="round" stroke-linejoin="round" d="M17 8L15 5" />
  <path stroke-linecap="round" stroke-linejoin="round" d="M17 8L19 5" />
  <!-- Skill nodes -->
...
const linearDashboardIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
  <!-- Vertical progress line -->
  <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16" />
  <!-- Progress nodes -->
  <circle cx="12" cy="6" r="2" fill="currentColor" />
  <circle cx="12" cy="12" r="2" fill="currentColor" />
  <circle cx="12" cy="18" r="2" stroke="currentColor" fill="none" />
  <!-- Horizontal detail lines -->
  <path stroke-linecap="round" stroke-linejoin="round" d="M15 6h4" />
  <path stroke-linecap="round" stroke-linejoin="round" d="M15 12h3" />
  <path stroke-linecap="round" stroke-linejoin="round" d="M15 18h2" />
</svg>`;

const mindMapIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
  <!-- Central node -->
  ...
  <!-- Connection lines -->
  <path stroke-linecap="round" stroke-linejoin="round" d="M9.5 10.5L6.5 8" />
  <path stroke-linecap="round" stroke-linejoin="round" d="M14.5 10.5L17.5 8" />
  <path stroke-linecap="round" stroke-linejoin="round" d="M9.5 13.5L6.5 16" />
  <path stroke-linecap="round" stroke-linejoin="round" d="M14.5 13.5L17.5 16" />
</svg>`;
...
const gymnasiumIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
...
const pipelineIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
  <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25H12" />
  <circle cx="17" cy="17.25" r="2.5" stroke="currentColor" fill="none" />
  ...
  getIcon(iconName: string): SafeHtml {
    ...
    switch (iconName) {
      ...
      case 'mentor':
        ...
        break;
      case 'metro-map':
        iconHtml = metroMapIcon;
        break;
      case 'skill-tree':
        iconHtml = skillTreeIcon;
        break;
      case 'linear-dashboard':
        iconHtml = linearDashboardIcon;
        break;
      case 'mind-map':
        iconHtml = mindMapIcon;
        break;
      case 'gymnasium':
        iconHtml = gymnasiumIcon;
        break;
      case 'pipeline':
