...
import { NotebooksService, NotebookProgress } from '@kasita/core-data';
import { AuthService } from '@kasita/core-data';

@Component({
  selector: 'app-notebook-progress',
  standalone: true,
  imports: [CommonModule, MaterialModule],
  templateUrl: './notebook-progress.html',
  styleUrl: './notebook-progress.scss',
})
