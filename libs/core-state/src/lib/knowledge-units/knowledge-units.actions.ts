...
export const KnowledgeUnitsActions = createActionGroup({
  ...
  events: {
    ...
    'Load KnowledgeUnits By SubConcept': props<{ subConceptId: string }>(),
    'Load KnowledgeUnits By SubConcept Success': props<{ knowledgeUnits: KnowledgeUnit[] }>(),
    'Load KnowledgeUnits By SubConcept Failure': props<{ error: string | null }>(),
