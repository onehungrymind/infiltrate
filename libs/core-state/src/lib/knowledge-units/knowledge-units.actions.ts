...
export const KnowledgeUnitsActions = createActionGroup({
  ...
  events: {
    ...
    'Load KnowledgeUnits By Path': props<{ pathId: string }>(),
    'Load KnowledgeUnits By Path Success': props<{ knowledgeUnits: KnowledgeUnit[] }>(),
    'Load KnowledgeUnits By Path Failure': props<{ error: string | null }>(),
