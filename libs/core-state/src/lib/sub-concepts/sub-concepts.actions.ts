...
export const SubConceptsActions = createActionGroup({
  ...
  events: {
    ...
    'Load SubConcepts By Principle': props<{ principleId: string }>(),
    'Load SubConcepts By Principle Success': props<{ subConcepts: SubConcept[] }>(),
    'Load SubConcepts By Principle Failure': props<{ error: string | null }>(),
    ...
    'Decompose Principle': props<{ principleId: string }>(),
    'Decompose Principle Success': props<{ subConcepts: SubConcept[]; message: string }>(),
    'Decompose Principle Failure': props<{ error: string | null }>(),
